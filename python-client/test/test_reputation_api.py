...
from swagger_client.apis.reputation_api import ReputationApi
...
class TestReputationApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.reputation_api.ReputationApi()
    ...
    def test_ip_put(self):
        """
        Test case for ip_put
